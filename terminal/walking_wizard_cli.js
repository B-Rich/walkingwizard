...
TerminalShell.commands['y'] = TerminalShell.commands['Y'] = TerminalShell.commands['yes'] = TerminalShell.commands['Yes'] = function(terminal) {
...
Filesystem = {
	'welcome.txt': {type:'file', read:function(terminal) {
		terminal.print($('<h4>').text('Hi there! Welcome. We want to help you get off your computer and WALK.'));
		//terminal.print('To navigate the comics, enter "next", "prev", "first", "last", "display", or "random".');
		terminal.print("First, let's help you discover what kind of walker you are. Ready? [Y/n]");
